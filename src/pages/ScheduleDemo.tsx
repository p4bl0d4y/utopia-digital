              ...
              <CardContent className="space-y-6">
                <form className="space-y-6">
                  ...
                  <div>
                    ...
                    <Input id="company" required className="w-full" />
                  </div>
                  ...
                  <div>
                    ...
                    <select id="solution" required className="w-full px-3 py-2 border border-input bg-background rounded-md focus:outline-none focus:ring-2 focus:ring-ring">
                  ...
                  <div>
                    ...
                    <Input id="preferredDate" type="date" required className="w-full" />
                  </div>
                  ...
                  <div>
                    ...
                    <select id="preferredTime" required className="w-full px-3 py-2 border border-input bg-background rounded-md focus:outline-none focus:ring-2 focus:ring-ring">
                      <option value="">Select a time</option>
                      <option value="9:00">9:00 AM EAT</option>
